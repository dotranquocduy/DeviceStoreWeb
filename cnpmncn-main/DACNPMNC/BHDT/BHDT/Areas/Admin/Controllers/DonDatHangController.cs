...
namespace BHDT.Areas.Admin.Controllers
{
    ...
    {
        private BHDTEntities db = new BHDTEntities();
        ...
        public ActionResult Index()
        {
            ...
            var donDatHangs = db.DonHangs.Include(d => d.TaiKhoan).Where(n=>n.MaLoaiTT==1);
        ...
        public ActionResult Index2()
        {
            ...
            var donDatHangs2 = db.DonHangs.Include(d => d.TaiKhoan).Where(n => n.MaLoaiTT == 2);
        ...
        public ActionResult Delete(int? id)
        {
            ...
            DonHang donDatHang = db.DonHangs.Find(id);
            if (donDatHang == null)
            {
                return HttpNotFound();
            }
        ...
        {
            DonHang donDatHang = db.DonHangs.Find(id);
            db.DonHangs.Remove(donDatHang);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
        public ActionResult SearchDonHang(string searchString)
        {
            return View(db.DonHangs.Where(dh => dh.TaiKhoan.TenTK.Contains(searchString) || searchString == null).ToList());
        ...
        {
            ViewBag.MaLoaiTT = new SelectList(db.TinhtrangDHs.OrderBy(n => n.TenTT), "MaLoaiTT", "TenTT");

            if (id== null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            DonHang model = db.DonHangs.SingleOrDefault(n => n.MaDDH == id);
            if(model == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        {
            ViewBag.MaLoaiTT = new SelectList(db.TinhtrangDHs.OrderBy(n => n.TenTT), "MaLoaiTT", "TenTT",dh.MaLoaiTT);
            ...
            DonHang ddhUpdate = db.DonHangs.Single(n => n.MaDDH == dh.MaDDH);
